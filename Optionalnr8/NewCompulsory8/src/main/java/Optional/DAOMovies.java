...
public class DAOMovies {
    ...
    public Movie findByID(int id) {
        try {
            ...
            if (movieRows.next()) {
                return new Movie(movieRows.getInt(1), movieRows.getString(2), movieRows.getDate(3), movieRows
                        .getInt(4), movieRows.getInt(5));
            }
            statement.close();
    ...
    public Movie findByTitlu(String title) {
        try {
